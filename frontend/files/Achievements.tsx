      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.div
            ...
            whileInView={{ scale: 1 }}
            viewport={{ once: true }}
            className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-[#ffd700]/20 to-[#ff8800]/20 mb-6"
          >
            <Trophy className="w-10 h-10 text-[#ffd700]" />
          </motion.div>
          <h2 className="text-4xl md:text-5xl font-game font-black mb-4">
            LEVEL UP YOUR <span className="text-[#ffd700]">GAME</span>
          </h2>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="game-card p-8 mb-12 max-w-2xl mx-auto"
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              >
                <currentRank.icon className="w-8 h-8" style={{ color: currentRank.color }} />
              </motion.div>
              <div>
                <div className="text-sm text-gray-400 mb-1">Current Rank</div>
                <div className="text-2xl font-game font-bold" style={{ color: currentRank.color }}>
                  {currentRank.name}
                </div>
              </div>
            </div>
          ...
          {nextRank && (
            <div>
              <div className="flex justify-between text-sm mb-2">
                ...
                <span className="font-numbers" style={{ color: nextRank.color }}>
                  {currentXP.toLocaleString()} / {nextRank.minXP.toLocaleString()} XP
                </span>
              </div>
              <div className="h-4 rounded-full bg-black/50 overflow-hidden">
                <motion.div
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {achievements.map((achievement, index) => (
            <motion.div
              ...
              className={`game-card p-6 relative overflow-hidden group ${
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-4">
                  ...
                  {achievement.unlocked ? (
                    <div className="px-3 py-1 rounded-full bg-[#00ff88]/20 border border-[#00ff88]/30">
                      <span className="text-xs font-bold text-[#00ff88]">UNLOCKED</span>
                    </div>
                  ) : (
                ...
                <h3 className="text-lg font-game font-bold text-white mb-1">
                  {achievement.name}
                </h3>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-numbers text-[#ffd700]">
                    +{achievement.xp} XP
                  </span>
                </div>
              </div>
        ...
        >
          <button className="px-8 py-3 rounded-xl bg-white/5 border border-white/10 text-white font-game text-sm hover:bg-white/10 hover:border-white/20 transition-all">
