  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: "linear-gradient(135deg, rgba(0, 255, 136, 0.2), rgba(0, 240, 255, 0.2), rgba(255, 0, 170, 0.2))",
          filter: "blur(20px)",
        }}
      />

      {/* Card */}
      <div className="relative game-card p-6 h-full flex flex-col">
        {/* Header Row */}
        ...
        <Link href={`/markets/${id}`} className="flex-grow">
          <h3 className="text-lg font-bold mb-4 leading-snug text-white group-hover:text-[#00f0ff] transition-colors">
            {question}
          </h3>
        </Link>
        ...
        <div className="mb-4">
          <div className="relative h-4 rounded-full overflow-hidden bg-black/50">
            {/* YES Side */}
            <motion.div
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href={`/markets/${id}`} className="flex-1">
            <motion.div
              className="text-left p-3 rounded-xl bg-[#00ff88]/10 border border-[#00ff88]/30 
          ...
          <Link href={`/markets/${id}`} className="flex-1">
            <motion.div
              className="text-right p-3 rounded-xl bg-[#ff0044]/10 border border-[#ff0044]/30 
        ...
        <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-[#00f0ff]/30 rounded-tl-xl opacity-0 group-hover:opacity-100 transition-opacity" />
        <div className="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-[#ff00aa]/30 rounded-tr-xl opacity-0 group-hover:opacity-100 transition-opacity" />
        <div className="absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 border-[#00ff88]/30 rounded-bl-xl opacity-0 group-hover:opacity-100 transition-opacity" />
        <div className="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-[#ffd700]/30 rounded-br-xl opacity-0 group-hover:opacity-100 transition-opacity" />
      </div>
    </motion.div>
  );
}
