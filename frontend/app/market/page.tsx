...
import {
  ...
  ArrowLeft, Flame, Target, Loader2
} from "lucide-react";
    ...
    return (
      <div className="min-h-screen pt-24 pb-32 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-2xl font-game text-white mb-2">Select a Market</h2>
          <p className="text-gray-400 mb-6">Browse available markets to place your predictions</p>
          <Link href="/markets">
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen pt-24 pb-32 px-4 flex items-center justify-center">
        <div className="text-center">
          <Loader2 className="w-12 h-12 text-[#00f0ff] animate-spin mx-auto mb-4" />
          <p className="text-gray-400 font-game">Loading...</p>
        </div>
      </div>
    }>
      <MarketContent />
