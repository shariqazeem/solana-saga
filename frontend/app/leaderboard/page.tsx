      ...
      <div className="relative z-10 pt-20 pb-24 px-4 min-h-screen">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            >
              <Trophy className="w-12 h-12 sm:w-16 sm:h-16 text-[#ffd700]" />
            </motion.div>
          ...
          {!loading && leaderboardData.length > 0 && (
            <>
              ...
              <motion.div
                ...
                className="flex justify-center items-end gap-2 sm:gap-3 mb-6 sm:mb-8 px-2 sm:px-4"
              >
                {/* 2nd Place */}
                {top3[1] && (
                  <div className="flex-1 max-w-[120px] sm:max-w-[160px]">
                    <motion.div
                      ...
                      className="game-card p-2 sm:p-3 text-center relative overflow-hidden"
                      style={{
                    ...
                    >
                      ...
                      <div className="text-2xl sm:text-3xl mb-1">{getAvatar(top3[1].ownerPubkey, 1)}</div>
                      <Medal className="w-4 h-4 sm:w-5 sm:h-5 text-[#c0c0c0] mx-auto mb-1" />
                      <div className="font-game text-white text-[10px] sm:text-xs truncate">{shortenAddress(top3[1].ownerPubkey)}</div>
                      <div className={`text-base sm:text-lg font-numbers font-bold ${microUsdToDollars(top3[1].realizedPnlUsd) >= 0 ? "text-[#00ff88]" : "text-[#ff0044]"}`}>
                        {microUsdToDollars(top3[1].realizedPnlUsd) >= 0 ? "+" : ""}${microUsdToDollars(top3[1].realizedPnlUsd).toFixed(0)}
                      </div>
                      <div className="text-[9px] sm:text-[10px] text-gray-400">2nd Place</div>
                    </motion.div>
                    <div className="h-12 sm:h-16 bg-gradient-to-t from-[#c0c0c0]/20 to-[#c0c0c0]/5 rounded-b-xl" />
                  </div>
                )}
                ...
                {top3[0] && (
                  <div className="flex-1 max-w-[140px] sm:max-w-[180px]">
                    <motion.div
                      ...
                      className="game-card p-3 sm:p-4 text-center relative overflow-hidden"
                      style={{
                    ...
                    >
                      ...
                      />
                      <div className="text-3xl sm:text-4xl mb-1">{getAvatar(top3[0].ownerPubkey, 0)}</div>
                      <Crown className="w-5 h-5 sm:w-6 sm:h-6 text-[#ffd700] mx-auto mb-1" />
                      <div className="font-game text-white text-xs sm:text-sm truncate">{shortenAddress(top3[0].ownerPubkey)}</div>
                      <div className={`text-xl sm:text-2xl font-numbers font-bold ${microUsdToDollars(top3[0].realizedPnlUsd) >= 0 ? "text-[#00ff88]" : "text-[#ff0044]"}`}>
                        {microUsdToDollars(top3[0].realizedPnlUsd) >= 0 ? "+" : ""}${microUsdToDollars(top3[0].realizedPnlUsd).toFixed(0)}
                      </div>
                      <div className="text-[10px] sm:text-xs text-[#ffd700]">Champion</div>
                    </motion.div>
                    <div className="h-16 sm:h-24 bg-gradient-to-t from-[#ffd700]/20 to-[#ffd700]/5 rounded-b-xl" />
                  </div>
                )}
                ...
                {top3[2] && (
                  <div className="flex-1 max-w-[120px] sm:max-w-[160px]">
                    ...
                    >
                      ...
                      <div className="text-2xl sm:text-3xl mb-1">{getAvatar(top3[2].ownerPubkey, 2)}</div>
                      <Medal className="w-4 h-4 sm:w-5 sm:h-5 text-[#cd7f32] mx-auto mb-1" />
                      <div className="font-game text-white text-[10px] sm:text-xs truncate">{shortenAddress(top3[2].ownerPubkey)}</div>
                      <div className={`text-base sm:text-lg font-numbers font-bold ${microUsdToDollars(top3[2].realizedPnlUsd) >= 0 ? "text-[#00ff88]" : "text-[#ff0044]"}`}>
                        {microUsdToDollars(top3[2].realizedPnlUsd) >= 0 ? "+" : ""}${microUsdToDollars(top3[2].realizedPnlUsd).toFixed(0)}
                      </div>
                      <div className="text-[9px] sm:text-[10px] text-gray-400">3rd Place</div>
                    </motion.div>
                    <div className="h-8 sm:h-10 bg-gradient-to-t from-[#cd7f32]/20 to-[#cd7f32]/5 rounded-b-xl" />
                  </div>
                )}
              </motion.div>
              ...
              >
                {/* Table Header */}
                <div className="grid grid-cols-10 sm:grid-cols-12 gap-1 sm:gap-2 px-3 sm:px-4 py-3 bg-white/5 border-b border-white/10 text-[10px] font-game text-gray-400">
                  <div className="col-span-1">Rank</div>
                  <div className="col-span-4">Trader</div>
                  <div className="col-span-2 text-center">Win Rate</div>
                  <div className="col-span-2 text-center hidden sm:block">Volume</div>
                  ...
                  {leaderboardData.slice(0, 20).map((player, index) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className={`grid grid-cols-10 sm:grid-cols-12 gap-1 sm:gap-2 px-3 sm:px-4 py-3 sm:py-4 items-center hover:bg-white/5 transition-colors group ${
                      ...
                      >
                        ...
                        <div className="col-span-1">
                          {player.rank <= 3 ? (
                            ...
                            >
                              <RankIcon className="w-3 h-3 sm:w-4 sm:h-4" style={{ color: style.border }} />
                            </motion.div>
                          ) : (
                            <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-white/5 flex items-center justify-center font-numbers font-bold text-gray-400 text-xs sm:text-sm">
                              {player.rank}
                            </div>
                          )}
                        </div>
                        ...
                        <div className="col-span-3 text-right">
                          <div className={`text-sm sm:text-lg font-numbers font-bold ${pnl >= 0 ? "text-[#00ff88]" : "text-[#ff0044]"}`}>
                            {pnl >= 0 ? "+" : ""}${pnl.toFixed(0)}
                          </div>
                        </div>
                      </motion.div>
                ...
                {userEntry && userEntry.rank > 20 && (
                  <div className="px-3 sm:px-4 py-3 sm:py-4 bg-gradient-to-r from-[#00f0ff]/10 to-[#ff00aa]/10 border-t border-[#00f0ff]/30">
                    <div className="grid grid-cols-10 sm:grid-cols-12 gap-1 sm:gap-2 items-center">
                      <div className="col-span-1">
                        <div className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-[#00f0ff]/20 border border-[#00f0ff]/50 flex items-center justify-center font-numbers font-bold text-[#00f0ff] text-xs sm:text-sm">
                          {userEntry.rank}
                        </div>
                      </div>
                      <div className="col-span-4 flex items-center gap-2">
                      ...
                      <div className="col-span-3 text-right">
                        <div className={`text-sm sm:text-lg font-numbers font-bold ${microUsdToDollars(userEntry.realizedPnlUsd) >= 0 ? "text-[#00ff88]" : "text-[#ff0044]"}`}>
                          {microUsdToDollars(userEntry.realizedPnlUsd) >= 0 ? "+" : ""}${microUsdToDollars(userEntry.realizedPnlUsd).toFixed(0)}
                        </div>
                      </div>
                    </div>
                  </div>
